...
INSERT INTO public.posts(id, tid, CPR, content, created_date) VALUES (1, 1, 1007889934, 'Ved anale smerter anbefaler vi en n&aelig;rmere unders&oslash;gelse hos egen l&aelig;ge.', '2018-09-03');
INSERT INTO public.posts(id, tid, CPR, content, created_date) VALUES (2, 1, 2412199955, 'Du b&oslash;r f&oslash;rst s&oslash;ge egen l&aelig;ge, som dern&aelig;st vil sende dig videre i systemet.', '2018-10-01');
INSERT INTO public.posts(id, tid, CPR, content, created_date) VALUES (3, 2, 1007889934,'Jeg vil lige tilf&oslash;je, at k&oslash;nsskifteoperationer er v&aelig;sentligt billigere i japan.', '2018-11-07');
INSERT INTO public.posts(id, tid, CPR, content, created_date, modified_date) VALUES (4, 1, 2412199955, 'F&aring; dig en s&oslash;dere k&aelig;reste.', '2018-05-11', '2018-05-11');
INSERT INTO public.posts(id, tid, CPR, content, created_date) VALUES (5, 2, 1007889934,'Du kan ogs&aring; overveje en cyborg operation for kun $999999999999.99', '2018-11-08');
